/*
  This is the todos.js main application file that uses the session persistence module from JS185 (Database App w/ JS) Lesson 3. 
*/
...
app.post("/lists/:todoListId/complete_all", (req, res, next) => {
  ...
  if (!res.locals.store.completeAllDone(+todoListId)) {
    next(new Error("Not found."));
  } else {
